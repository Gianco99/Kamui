Sample Configs
==============
We define JSON file per sample family. Each file declares a set of datasets to process, and everything in it becomes selectable from the command line.
...
Every sample ends up with these, while anything else is rejected on load.
  ...
  nFilesFor10k   Files needed for roughly 10k events.
